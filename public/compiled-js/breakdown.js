...
var breakdowntable_1 = __webpack_require__(25);
var BreakdownPage = (function (_super) {
    __extends(BreakdownPage, _super);
    function BreakdownPage() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BreakdownPage.prototype.calcTotal = function (debtList) {
        var total = 0;
    ...
    BreakdownPage.prototype.render = function () {
        var youOweSection = (React.createElement("div", { className: "breakdown-section" },
            React.createElement("h2", { className: "breakdown-header" },
                "You owe a total of $",
                this.calcTotal(this.props.youOwe).toFixed(2),
                " to ",
                this.props.youOwe.length,
                " ",
                this.props.youOwe.length == 1 ? "person" : "people",
                "."),
            React.createElement(breakdowntable_1.BreakdownTable, { debts: this.props.youOwe })));
        var owesYouSection = (React.createElement("div", { className: "breakdown-section" },
            React.createElement("h2", { className: "breakdown-header" },
                this.props.owesYou.length,
                " ",
                this.props.youOwe.length == 1 ? "person owes" : "people owe",
                " you a total of $",
                this.calcTotal(this.props.owesYou).toFixed(2),
                "."),
            React.createElement(breakdowntable_1.BreakdownTable, { debts: this.props.owesYou })));
        var netMoney = this.calcTotal(this.props.owesYou)
            - this.calcTotal(this.props.youOwe);
        return (React.createElement("div", { className: "breakdown-container" },
            this.props.youOwe.length == 0 ? "" : youOweSection,
            this.props.owesYou.length == 0 ? "" : owesYouSection,
            React.createElement("div", { className: "breakdown-section breakdown-summary" },
                "Overall, you ",
                netMoney > 0 ? "gained" : "spent",
                " $",
                Math.abs(netMoney).toFixed(2))));
    };
    return BreakdownPage;
}(React.Component));
exports.BreakdownPage = BreakdownPage;
...
var breakdownpage_1 = __webpack_require__(20);
var debts = {
    youOwe: [{
            name: "Daniel Grocki",
            amount: 42.06
...
ReactDOM.render(React.createElement(breakdownpage_1.BreakdownPage, { youOwe: debts.youOwe, owesYou: debts.owesYou }), 
...
var BreakdownTable = (function (_super) {
    __extends(BreakdownTable, _super);
    function BreakdownTable() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BreakdownTable.prototype.render = function () {
        var debtsContents = this.props.debts.map(function (debt, index) {
            return (React.createElement("tr", { className: "debts-table-row", key: index },
                React.createElement("td", { className: "debts-table-name" }, debt.name),
                React.createElement("td", { className: "debts-table-amount" },
                    "$",
                    debt.amount.toFixed(2))));
        });
        return (React.createElement("table", { className: "debts-table" }, debtsContents));
    };
